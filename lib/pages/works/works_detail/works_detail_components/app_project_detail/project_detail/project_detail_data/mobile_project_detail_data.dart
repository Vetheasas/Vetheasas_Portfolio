...
import '../project_detail_components/mobile_project_detail_components/mobile_project_detail_components.dart';

List<Widget> mobileIDIProjectDetailData = [
...
List<Widget> mobilePortfolioProjectDetailData = [
  AboutThisProject(),
  ...
  ProjectDetailText(
      projectDetailText:
          'On the work page, I created a custom widget that preview my work including the app or website\'s color scheme and a short description of the website.'),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: AutoSizeText(
        ...
        maxLines: 1,
        style: TextStyle(
            fontSize: 35, fontFamily: 'SFUIText', fontWeight: FontWeight.w900),
      ),
    );
  }
}
